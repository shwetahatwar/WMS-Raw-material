...
import com.briot.balmerlawrie.implementor.repository.remote.ProjectList
...
class ProjectFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        this.recyclerView = rootView.findViewById(R.id.project_recyclerview)
        layoutManager = LinearLayoutManager(this.activity)
        recyclerView.layoutManager = layoutManager
        adapter = ProjectListAdapter(recyclerView, viewModel.projectList, viewModel)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = ProjectListAdapter(recyclerView, viewModel.projectList, viewModel)
...
open class ProjectListAdapter(private val recyclerView: androidx.recyclerview.widget.RecyclerView,
                                          private val projectList: LiveData<Array<ProjectList?>>,
                                          private val viewModel: ProjectViewModel) :
        androidx.recyclerview.widget.RecyclerView.Adapter<ProjectListAdapter.ViewHolder>() {
...
//        println("status:--"+status)
        ...
        holder.itemView.setOnClickListener {
            ...
            Navigation.findNavController(it).navigate(R.id.action_projectFragment_to_issueToProductionMasterFragment, bundle)
        }
    }
